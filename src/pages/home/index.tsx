...
const About = dynamic(() => import('templates/AboutSection'))
const Portfolio = dynamic(() => import('templates/PortfolioSection'))
const Contacts = dynamic(() => import('templates/ContactSection'))
const HomeSection = dynamic(() => import('templates/HomeSection'))
